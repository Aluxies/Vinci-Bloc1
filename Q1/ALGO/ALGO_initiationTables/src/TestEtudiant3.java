 ...
 */public class TestEtudiant3{
	...
	public static java.util.Scanner scanner = new java.util.Scanner(System.in);
   	...
   	public static void main(String [] args){
		...
		do{
			...
			System.out.println("5 -> Tester la methode nombreUEValidees");
			System.out.print("\nEntrez votre choix : ");
			...
			switch(choix){
				...
				case 5: verifierNombreUEValidees(); break;
				}
	...
	private static void verifierNombreUEValidees(){
		...
		// Test1 : 3 cotes - 2 UE validees
		double[] tableTestee1 = {17,14,6};
		etudiant = new Etudiant(1,tableTestee1);
		UEValidees = etudiant.nombreUEValidees();
		if(UEValidees != 2){
			System.out.print("\nAttention! Test1 ko : votre methode a trouve "+ UEValidees +" comme nombre d'UE validees");
			System.out.println(" pour l'etudiant : "+ etudiant.toString());
			tousReussis = false;
		}

		// Test2 : 5 cotes - 4 UE validees
		double[] tableTestee2 = {13,14,16,8,17};
		etudiant = new Etudiant(2,tableTestee2);
		UEValidees = etudiant.nombreUEValidees();
		if(UEValidees != 4){
			System.out.print("\nAttention! Test2 ko : votre methode a trouve "+ UEValidees +" comme nombre d'UE validees");
			System.out.println(" pour l'etudiant : "+ etudiant.toString());
			tousReussis = false;
		}

		// Test3 : 5 cotes - 3 UE validees
		double[] tableTestee3 = {13,14,16,8,7};
		etudiant = new Etudiant(3,tableTestee3);
		UEValidees = etudiant.nombreUEValidees();
		if(UEValidees != 3){
			System.out.print("\nAttention! Test3 ko : Votre methode a trouve "+ UEValidees +" comme nombre d'UE validees");
			System.out.println(" pour l'etudiant : "+ etudiant.toString());
			tousReussis = false;
		}
		if(tousReussis)

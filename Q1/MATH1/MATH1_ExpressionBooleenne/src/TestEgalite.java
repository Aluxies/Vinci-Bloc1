public class TestEgalite{
	...
	private static boolean auPlusUneEgalite(int nombre1, int nombre2, int nombre3){
		...
		return ( nombre1 == nombre2 && nombre1 != nombre3 ) || // 1 == 2 != 3
				( nombre1 == nombre3 && nombre1 != nombre2 ) || // 1 == 3 != 2
				( nombre2 == nombre3 && nombre1 != nombre2 ) || // 2 == 3 != 1
				( nombre1 != nombre2 && nombre2 != nombre3 ); // 2 != 1 != 3

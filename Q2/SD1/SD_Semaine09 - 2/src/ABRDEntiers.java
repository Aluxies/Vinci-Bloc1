...
public class ABRDEntiers {
	...
	public void insere (int entier) {
		...
		if ( racine == null ) racine = new NoeudEntier( entier );
		else insere( entier, racine );
		
	}

	private void insere ( int entier , NoeudEntier noeud ){

		NoeudEntier new_noeud = new NoeudEntier( entier );

		if ( entier < noeud.entier ){

			if ( noeud.gauche == null ) noeud.gauche = new_noeud;
			else insere( entier, noeud.gauche );

		} else {

			if ( noeud.droit == null ) noeud.droit = new_noeud;
			else insere( entier, noeud.droit );
	...
	public boolean contient (int entier) {
		...
		return contient( entier, racine );
	
	}

	private boolean contient ( int entier, NoeudEntier noeud ){

		if ( noeud == null ) return false;
		if ( noeud.entier == entier ) return true;
		if ( entier > noeud.entier ) return contient( entier, noeud.droit );
		else return contient( entier, noeud.gauche );

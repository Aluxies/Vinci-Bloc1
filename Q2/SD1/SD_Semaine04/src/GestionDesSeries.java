...
public class GestionDesSeries {
	...
	private static void rechercherSerie() {
		...
		SerieEtudiants serie = classe.getSerieEtudiants( numeroSerie );
		System.out.println( "Serie trouvée :" );
	...
	private static void afficherTailleSeries() {
		...
		String string = "Taille des séries :\n\n";

		for (int i = 0; i < classe.nombreSeries(); i++) {

			SerieEtudiants serie = classe.getSerieEtudiants( i+1 );
			string += "taille série n°" + serie.getNumeroSerie() + " : " + serie.nombreEtudiants() + "\n";

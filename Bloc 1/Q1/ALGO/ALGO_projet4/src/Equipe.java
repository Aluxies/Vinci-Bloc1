...
public class Equipe {
	...
	public Candidat selectionnerCandidat(){
		...
		Candidat premierCandidat = tableCandidats[0];
	...
	public boolean remettreEnJeu(Candidat candidat){
		...
		if ( nombreCandidats == tableCandidats.length ) return false;

		if ( candidat == null ) throw new IllegalArgumentException( "Le candidat ne peut être 'nul'" );

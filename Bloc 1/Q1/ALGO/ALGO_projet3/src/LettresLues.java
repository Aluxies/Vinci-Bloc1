public class LettresLues {
    ...
    public boolean lettreDejaLue(char lettre){
        ...
        int indice = unicode - 65;

        return tableLettresLues[indice];
    ...
    public void ajouterLettreLue(char lettre) {
        ...
        tableLettresLues[indice] = true;

    }

    //A NE PAS MODIFIER
    //VA SERVIR POUR LES TESTS
    public LettresLues(boolean[] tableARecopier) {
        this.tableLettresLues = new boolean[26];
        for (int i = 0; i < tableARecopier.length ; i++) {
            tableLettresLues[i]=tableARecopier[i];
        }
    }

public class TestLettresLues {
    ...
    public static void main (String[] args) {
        ...
        do{
            ...
            System.out.println("2 -> Tester la methode 'ajouterLettreLue()'");
            System.out.print("\nEntrez votre choix : ");
            choix=scanner.nextInt();
            switch(choix){
                case 1: testLettreDejaLue();
                    break;
                case 2: testAjouterLettreLue();
                    break;
            }
    ...
    private static void testAjouterLettreLue() {
        System.out.println();
        System.out.println("ajouterLettreLue");
        System.out.println("----------------");
        ...
        try{
            ...
            System.out.println("Les lettres lues : "+lettres.toString());
            char lettre = 'X';
            System.out.println("lettre ajoutee : "+lettre);
            lettres.ajouterLettreLue(lettre);
            assertEquals("test " + numeroTest + " ko : contenu ko ","A B I X Z", lettres.toString());
        } catch (ArrayIndexOutOfBoundsException e) {
            System.out.println("test " + numeroTest + " ko, il y a eu sortie de table");
            e.printStackTrace();
            System.exit(0);
        ...
        try{
            ...
            System.out.println("lettre ajoutee : "+lettre);
            lettres.ajouterLettreLue(lettre);
            assertEquals("test " + numeroTest + " ko : contenu ko ","A B I Z", lettres.toString());
        } catch (ArrayIndexOutOfBoundsException e) {
            System.out.println("test " + numeroTest + " ko, il y a eu sortie de table");
            e.printStackTrace();
            System.exit(0);

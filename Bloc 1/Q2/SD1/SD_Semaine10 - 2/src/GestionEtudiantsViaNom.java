...
public class GestionEtudiantsViaNom {
    ...
    private static ComparateurViaNom comparateurViaNom = new ComparateurViaNom();
    private static TreeSet<Etudiant> ensembleEtudiants = new TreeSet<Etudiant>( comparateurViaNom );

...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println( "contient croquette? : " + livre.contient( croquette ) );
		System.out.println( "contient Waterzooi? : " + livre.contient( plat ) );

		System.out.println(livre);
		Plat toasts = new Plat("Toasts aux champignons", 5, Difficulte.XXX, Cout.$$$, Plat.Type.ENTREE);
		livre.supprimerPlat( toasts );
		System.out.println( "contient toasts? : " + livre.contient( toasts ) );
		System.out.println(livre);

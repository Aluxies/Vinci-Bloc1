...
public class ClassAnalyzer {
    ...
    public JsonObject getMethod(Method m) {
        ...
        objectBuilder.add("parameters", getMethodParams(m));
     ...
     * Example :
     * [ {}, {} ]
     * This method rely on the getMethod() method to handle each field one by one.
     */
    ...
    public JsonArray getMethodParams(Method m) {
        JsonArrayBuilder arrayBuilder = Json.createArrayBuilder();

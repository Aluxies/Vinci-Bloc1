...
public class ExerciceGroupingBy {
    ...
    private void groupBy1() {
        ...
        Map<Trader, List<Transaction>> mapTraders = transactions
                .stream()
                .collect(Collectors.groupingBy( Transaction::getTrader ));

        System.out.println( mapTraders );
    ...
    private void groupBy2() {
        ...
        Map<Trader, Long> mapTraders = transactions
                .stream()
    ...
    private void groupBy3() {
        ...
        Map<TransactionsLevel, List<Transaction>> mapTransactionsLevel = transactions
                .stream()
        ...
        System.out.println( mapTransactionsLevel );
